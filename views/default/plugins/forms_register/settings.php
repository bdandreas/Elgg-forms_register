...
echo elgg_view_field(array(
    '#type' => 'select',
    'name' => 'params[header_enabled]',
    'value' => $entity->header_enabled,
    'options_values' => array(
        0 => elgg_echo('option:no'),
        1 => elgg_echo('option:yes'),
    ),
    '#label' => elgg_echo('settings:forms:register:header_enabled'),
    '#help' => elgg_echo('settings:forms:register:header_enabled:help'),
));
